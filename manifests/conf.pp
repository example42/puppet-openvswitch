#
# = Define: openvswitch::conf
#
# With this define you can manage any openvswitch configuration file
#
# == Parameters
#
# [*template*]
...
#   Example: template => 'site/openvswitch/my.conf.erb',
#
# [*content*]
...
#   Example: source => 'puppet:///site/openvswitch/my.conf',
#
# [*ensure*]
...
define openvswitch::conf (
  ...
  $manage_require = pickx($require, $openvswitch::config_file_require)
  $manage_notify  = pickx($notify, $openvswitch::manage_config_file_notify)
  $manage_replace = pickx($replace, $openvswitch::config_file_replace)

  file { "openvswitch_conf_${name}":
    ensure  => $ensure,
    source  => $source,
